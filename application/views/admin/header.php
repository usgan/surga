...
<head>
        <!-- Title -->
<<<<<<< HEAD
        <title>Admin Food Ecomers</title>
...
<<<<<<< HEAD
        ...
        <!--digunakan untuk keperluan alert-->
        <link href="<?php echo base_url()."assets/admin/confirm/"?>jquery-confirm.min.css" rel="stylesheet" type="text/css">
        <script src="<?php echo base_url()."assets/admin/confirm/"?>jquery-confirm.min.js"></script>
...
=======
        ...
        <link href="<?php echo base_url()?>/assets/admin/plugins/x-editable/bootstrap3-editable/css/bootstrap-editable.css" rel="stylesheet" type="text/css">
        <link href="<?php echo base_url()?>/assets/admin/plugins/bootstrap-datepicker/css/datepicker3.css" rel="stylesheet" type="text/css"/>
