		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="panel panel-white">
				<div class="panel-body">
					<a href="<?php echo site_url('smenu/show/'.$menu.'/'.$submenu)?>" class="btn btn-primary menu-button">Sub Menu</a>
			...
			<div class="panel panel-white">
				...
				<div class="panel-body">
					<div class="row">
						<form action="<?php echo site_url('smenu/show/'.$menu.'/'.$submenu)?>" method="GET" class="col-md-offset-8 col-md-4" >
